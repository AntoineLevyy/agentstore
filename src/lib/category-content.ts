...
const defaultContent: CategoryContent = {
  userMoment: "Find an AI agent that fits the task, tools, pricing, and level of trust you need.",
  visualDirection: "A decision surface: clear task outcomes, fit signals, integrations, pricing, and proof.",
  useCases: ["Compare agents", "Check integrations", "Review pricing", "Evaluate trust"],
  trustSignals: ["Publisher identity", "Data access", "Pricing clarity", "Recent updates"],
  seoAngles: ["best AI agents", "AI agent directory", "AI tools comparison"],
  examples: ["OpenAI GPTs", "Zapier agents", "workflow assistants"],
...
export const categoryContent: Record<string, CategoryContent> = {
  productivity: {
    ...
    seoAngles: ["best AI productivity agents", "AI calendar assistants", "AI meeting note takers", "AI task management agents"],
  ...
  "developer-tools": {
    ...
    seoAngles: ["best AI coding agents", "AI code review tools", "AI debugging agents", "AI developer tools"],
  ...
  writing: {
    ...
    seoAngles: ["best AI writing agents", "AI SEO writers", "AI copywriting agents", "AI blog writing tools"],
  ...
  research: {
    ...
    seoAngles: ["best AI research agents", "AI agents with citations", "AI literature review tools", "AI market research agents"],
  ...
  "data-analysis": {
    ...
    seoAngles: ["best AI data analytics agents", "AI BI agents", "natural language analytics tools", "AI SQL agents"],
  ...
  "customer-support": {
    ...
    seoAngles: ["best AI customer support agents", "AI helpdesk automation", "AI support chatbot", "AI customer service agents"],
  ...
  creative: {
    ...
    seoAngles: ["best AI creative agents", "AI video agents", "AI image generation agents", "AI music agents"],
  ...
  education: {
    ...
    seoAngles: ["best AI education agents", "AI tutoring agents", "AI lesson planning tools", "AI study assistants"],
  ...
  finance: {
    ...
    seoAngles: ["best AI finance agents", "AI bookkeeping agents", "AI financial analysis tools", "AI budgeting agents"],
  ...
  "sales-marketing": {
    ...
    seoAngles: ["best AI sales agents", "AI SDR agents", "AI marketing agents", "AI campaign automation tools"],
  ...
  "health-wellness": {
    ...
    seoAngles: ["best AI fitness agents", "AI health coach", "AI nutrition planner", "AI workout assistant"],
  ...
  "shopping-home": {
    ...
    seoAngles: ["best AI shopping assistants", "AI product recommendation agents", "AI deal finder", "AI personal shopper"],
  ...
  "travel-lifestyle": {
    ...
    seoAngles: ["best AI travel agents", "AI trip planner", "AI itinerary generator", "AI travel planning assistant"],
  ...
  "learning-skills": {
    ...
    seoAngles: ["AI language tutor", "AI cooking coach", "AI music tutor", "best AI skill-learning agents"],
  ...
  "legal-admin": {
    ...
    seoAngles: ["best AI legal agents", "AI contract review tools", "AI immigration assistant", "AI tax assistant"],
