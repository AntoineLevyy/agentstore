...
export const metadata: Metadata = {
  title: "App Store — AI apps for what you want done",
  description:
    "Search by what you want done and compare consumer AI apps across work, home, money, learning, travel, creativity, and life admin.",
  icons: {
    icon: "/favicon.png",
  },
  openGraph: {
